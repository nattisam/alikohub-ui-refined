...
const challenges = [
  { icon: GraduationCap, title: "Education–Labor Disconnect", summary: "Graduates lack practical experience for job markets." },
  ...
  { icon: Leaf, title: "Climate–Health Silos", summary: "Health and climate challenges addressed in isolation." },
...
const responses = [
  ...
  { icon: Handshake, value: "15–25", label: "Partnerships/yr", desc: "Public-private partnerships" },
